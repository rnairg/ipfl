package com.ipfl.player.relationship.plTeam;
...
import com.ipfl.player.PlayerRepository;
import com.ipfl.services.IpflDataService;

@Service("ipflPLRelationshipService")
public class IpflPLRelationshipService implements IpflDataService<RelationshipTemp> {
	...
	public List<RelationshipTemp> create(List<RelationshipTemp> rt) {
		for(RelationshipTemp rt1 : rt) {
			playerRepository.createPLRelationship(rt1.getStartNode(),rt1.getEndNode(),rt1.getRoles());
		}
		return null;
	}
